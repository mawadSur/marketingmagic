...
from app.services import byo
from app.services import state as sm
from app.services import task as tm
from app.utils import file_security, utils

# 认证依赖项 — enforced when an api_key/MPT_API_KEY is configured (see base.verify_token).
# Locks /videos, /tasks, /download, /stream etc. to the orchestrator (Marketing Magic).
...
def create_task(
    ...
    try:
        task = {
            ...
            # BYO: redact customer secrets so they never reach logs (line below).
            "params": byo.redact(body.model_dump()),
        }
